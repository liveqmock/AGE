...
import com.age.back.exception.NetWorkException;
...
public class HttpclientUtil {
	...
	public static String post(String url, String str) throws Exception {
		...
		try {
			...
			throw new NetWorkException("客户端连接协议错误", e);
		} catch (IOException e) {
			throw new NetWorkException("IO操作异常", e);
		} finally {
	...
	* @return 响应消息
	*/
	public static String get(String url, Map<String, String> params) throws NetWorkException {
	...
	* @return 响应消息
	 * @throws NetWorkException 
	*/
	public static String get(String url, Map<String, String> params, String charset) throws NetWorkException {
		if (url == null || StringUtils.isEmpty(url)) {
			return null;
		}
	...
	* @return 响应消息
	*/
	public static String post(String url, Map<String, String> params) throws NetWorkException {
	...
	* @return 响应消息
	*/
	public static String post(String url, Map<String, String> params, String charset) throws NetWorkException {
		if (url == null || StringUtils.isEmpty(url)) {
			return null;
		}
		// 创建HttpClient实例
		...
		try {
			...
			throw new NetWorkException("不支持的编码集", e);
		}
		HttpPost hp = new HttpPost(url);
	...
	*/
	public static String post(String url, Map<String, String> params, String charset, final URL keystoreUrl,
		...
		try {
			...
			throw new NetWorkException("指定的加密算法不可用", e);
		} catch (KeyStoreException e) {
			throw new NetWorkException("keytore解析异常", e);
		} catch (CertificateException e) {
			throw new NetWorkException("信任证书过期或解析异常", e);
		} catch (FileNotFoundException e) {
			throw new NetWorkException("keystore文件不存在", e);
		} catch (IOException e) {
			throw new NetWorkException("I/O操作失败或中断 ", e);
		} catch (UnrecoverableKeyException e) {
			throw new NetWorkException("keystore中的密钥无法恢复异常", e);
		} catch (KeyManagementException e) {
			throw new NetWorkException("处理密钥管理的操作异常", e);
		} finally {
			abortConnection(hp, httpclient);
		}
		return responseStr;
	...
	private static DefaultHttpClient getDefaultHttpClient() {
		return getDefaultHttpClient(CHARSET_UTF8);
	}
