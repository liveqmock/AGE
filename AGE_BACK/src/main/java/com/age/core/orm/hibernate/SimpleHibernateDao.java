 ...
 */
package com.age.core.orm.hibernate;
...
import com.age.core.utils.AssertUtils;
import com.age.core.utils.ReflectionUtils;
...
public class SimpleHibernateDao<T, ID extends Serializable> {
	...
	public <X> List<X> findVO(final String hql, final Map<String, ?> values, Class<X> clasz) {
		return createQuery(hql, values).setResultTransformer(new AliasToBeanResultTransformer(clasz)).list();
	}
	...
	public Query createQuery(final String queryString, final Object... values) {
		...
		Query query = getSession().createQuery(OrmUtil.convertSql(queryString));
		if (values != null) {
	...
	public <X> List<X> findSQL(final String sql, final Map<String, ?> values, Class<X> clasz) {
		return createSQLQuery(sql, values).setResultTransformer(new AliasToBeanResultTransformer(clasz)).list();
	}
	...
	/*public List<T> find(DetachedCriteria detachedCriteria) {
		Criteria c = detachedCriteria.getExecutableCriteria(this.getSession());
		return c.list();
	}

	public T findUnique(DetachedCriteria detachedCriteria) {
		return (T) detachedCriteria.getExecutableCriteria(this.getSession()).uniqueResult();
	}*/
}