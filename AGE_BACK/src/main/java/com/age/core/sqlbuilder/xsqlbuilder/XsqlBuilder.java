package com.age.core.sqlbuilder.xsqlbuilder;
...
import com.age.core.sqlbuilder.datamodifier.DataModifierUtils;
import com.age.core.sqlbuilder.xsqlbuilder.safesql.DirectReturnSafeSqlProcesser;
...
//	private static final String REPLACE_KEY_END_CHAR = "]";
	 ...
	 * @return 
	 */
	public XsqlFilterResult generateSql(String sourceXsql, Object obj) {
		Map filters = BeanUtils.Obj2Map(obj);
		XsqlFilterResult sfr = applyFilters(sourceXsql, filters);
		return new XsqlFilterResult(replaceKeyMaskWithString(sfr.getXsql(), sfr.getAcceptedFilters(),"?"),sfr.getAcceptedFilters());
	}
	/**
	 ...
	 * @return 
	 */
	public XsqlFilterResult generateHql(String sourceXsql, Object obj) {
		Map filters = BeanUtils.Obj2Map(obj);
		XsqlFilterResult sfr = applyFilters(sourceXsql, filters);
        String resultHql = sfr.getXsql();
		for(Iterator it = sfr.getAcceptedFilters().keySet().iterator();it.hasNext();){
