...
var svrname = window.location.host;
var IMAGESPATH;
link = link.substring(0, link.indexOf("/"));
//if(svrname.indexOf("8080")!=-1){
	IMAGESPATH = location.protocol + "//" + location.host + "/" + link  + '/scripts/zDialog/images/'; //图片路径配置
//}else if(svrname.indexOf("8090")!=-1){
	//IMAGESPATH = location.protocol + "//" + location.host + "/" + link  + '/scripts/zDialog/images/'; //图片路径配置
//}
//else{
//	IMAGESPATH = '/scripts/zDialog/images/';
//}
