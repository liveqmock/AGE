...
function OpenFile(url) {
	...
	AipObj.SetValue("SET_ABOUT_TIPS", "j9OZWJ9Aq4aQz46th56Oj6SKoo{sfa{Y");
}
/****************************************************************************************************
...
function AddSeal(usertype,doaction,other,httpaddr) {
	...
	if(usertype==0){
		...
		var islogin=AipObj.Login(other,3,65535,"","http://"+httpaddr+":9230/Seal/general/interface/");
	//var islogin=AipObj.Login(other,3,65535,"","http://"+httpaddr+":8089/inc/seal_interface/");
		...
		var islogin=AipObj.LoginEx("http://"+httpaddr+":9230/Seal/general/interface/", stri, strj);
